...
import com.jetcahe.support.redis.JedisPipelineConnectionFactory;
...
@Configuration
public class JedisConnectionAutoConfiguration extends JedisConnectionConfiguration {
    public JedisConnectionAutoConfiguration(RedisProperties properties,
    ...
    private RedisConnectionFactory createJedisConnectionFactory(
        ...
        if (getClusterConfiguration() != null) {
            return new JedisPipelineConnectionFactory(getClusterConfiguration(), clientConfiguration);
        }
